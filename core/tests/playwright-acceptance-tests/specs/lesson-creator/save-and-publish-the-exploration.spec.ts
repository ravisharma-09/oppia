...
test.describe('Lesson Creator', function () {
  ...
  test('should discard the draft exploration', async function () {
  ...
  test('should change the first card of the exploration', async function () {
  ...
  test('should remove an existing state', async function () {
